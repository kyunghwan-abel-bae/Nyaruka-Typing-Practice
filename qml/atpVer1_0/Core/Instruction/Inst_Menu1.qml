/**
  ...
  @QML FileName : Inst_Menu1.qml
  @Date : 2013-07-05
  @Writer : Kyunghwan Bae
  @Modified :
  @QML Description :
  Instruction Page for Menu1
*/

import QtQuick 2.0
import QtGraphicalEffects 1.0

import "Inst_Menu1_Parts"
...
Item {
    ...
    property string langExplanation_en : "Basic practice to memorize finger positioning.\nSimply type the shown letter with corresponding finger.\nSelect level and press Start to continue."
    property string langExplanation_rw : "Kumenyereza by'ibanze intoki kwandika inyuguti.\nAndika izo nyuguti ukoresheje intoki zibigomba.\nHitamo icyiciro ubundi ukore kuri Start ubundi ukomeze kwandika."
    ...
    Component.onCompleted: {
        level = itemInst_Menu1.parent.positionLevel
        itemLevels.x = (level-1) * -570
        itemLevelsX = (level-1) * -570

        selectedLanguage = itemInst_Menu1.parent.selectedLanguage
    ...
    */
    ...
    Rectangle{
        ...
        Item{
            ...
            Item{ // Rectangle(80FFFFFF) - lowquality
                id: rectContainer
        ...
        Inst_Buttons{
            ...
            onBtnGo: {
                itemInst_Menu1.parent.positionLevel = level
                itemInst_Menu1.parent.source = "../Menu1.qml"
            }
        }
    }
